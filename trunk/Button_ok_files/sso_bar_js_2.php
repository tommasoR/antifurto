...
function ssoGenerateLogoutBar($username) {
  ...
  $r += '<div class="li sep">|</div> ';
	  ...
	  $r += '<div class="li sep">|</div> ';
	    $r += '<div class="li gh"><a class="t0" href="http://arduino.cc/help/">Help</a></div> ';
  $r += '<div class="lo sep">|</div> ';
  $r += '<div class="li"><a href="https://id.arduino.cc/auth/logout/?returnurl=http%3A%2F%2Farduino.cc%2Fen%2F">Sign out</a></div>';
  document.getElementById("loginInfo").innerHTML = $r; 
}

// create the login bar
function ssoGenerateLoginBar() {
  $r  = '<div class="lo gh"><a class="t0" href="http://arduino.cc/help/">Help</a></div> ';
  $r += '<div class="lo sep">|</div> ';
  $r += '<div class="lo"><a href="https://id.arduino.cc/auth/login/?returnurl=http%3A%2F%2Farduino.cc%2Fen%2FTutorial%2FDigitalPins">Sign in</a> or ';
  $r += '<a href="https://id.arduino.cc/auth/register/?returnurl=http%3A%2F%2Farduino.cc%2Fen%2FTutorial%2FDigitalPins">Register</a></div>';
  document.getElementById("loginInfo").innerHTML = $r;
}
...
function ssoGenerateNavigationBar($username) {
  $r = '';
    $r += '<a class="t1" href="http://arduino.cc/en/">Main Site</a> ';
    $r += '<a class="t0" href="http://arduino.cc/blog/">Blog</a> ';
    $r += '<a class="t0" href="http://arduino.cc/playground/">Playground</a> ';
