...
function ssoGenerateLogoutBar($username) {
  ...
  $r += '<div class="li"><a href="https://id.arduino.cc/auth/logout/?returnurl=http%3A%2F%2Farduino.cc%2Fplayground%2F">Sign out</a></div>';
...
function ssoGenerateLoginBar() {
  ...
  $r += '<div class="lo sep">|</div> ';
  $r += '<div class="lo"><a href="https://id.arduino.cc/auth/login/?returnurl=http%3A%2F%2Fwww.arduino.cc%2Fplayground%2F">Sign in</a> or ';
  $r += '<a href="https://id.arduino.cc/auth/register/?returnurl=http%3A%2F%2Fwww.arduino.cc%2Fplayground%2F">Register</a></div>';
  document.getElementById("loginInfo").innerHTML = $r;
}
